...
--> statement-breakpoint
ALTER TABLE "counter_history" ADD COLUMN "changed_by" text;--> statement-breakpoint
...
DO $$ BEGIN
 ALTER TABLE "counter_history" ADD CONSTRAINT "counter_history_changed_by_user_id_fk" FOREIGN KEY ("changed_by") REFERENCES "user"("id") ON DELETE set null ON UPDATE no action;
EXCEPTION
