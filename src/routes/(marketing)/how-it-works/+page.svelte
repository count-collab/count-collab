...
<MetaTags
  title="How It Works — Count Collab"
  description="Learn how to create a shared counter, share the link, collaborate in real time, and organize counters into dashboards — all in under a minute."
  path="/how-it-works"
/>

<div class="max-w-4xl mx-auto px-4 py-16 sm:py-24">
  <div class="text-center mb-16">
    <h1 class="text-4xl sm:text-5xl font-extrabold text-slate-900 dark:text-slate-100">How It Works</h1>
  ...
  <div>
    ...
    <div class="flex gap-6">
      <div class="flex flex-col items-center">
        <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-blue-600 text-white font-bold text-lg">1</div>
        <div class="flex-1 w-px bg-slate-200 dark:bg-slate-700"></div>
      </div>
      <div class="pb-12">
        <h2 class="flex h-12 items-center text-xl font-bold text-slate-900 dark:text-slate-100">Create a Counter</h2>
        <p class="mt-3 text-slate-600 dark:text-slate-400 leading-relaxed">
          Click "Create a Counter" and give it a name and optional description. Choose your visibility setting: <strong>public</strong> (anyone can view and increment), <strong>public read-only</strong> (anyone views, only members increment), or <strong>private</strong> (members-only access). No account required for public counters — start counting in seconds.
        </p>
      </div>
    </div>
    ...
    <div class="flex gap-6">
      <div class="flex flex-col items-center">
        <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-blue-600 text-white font-bold text-lg">2</div>
        <div class="flex-1 w-px bg-slate-200 dark:bg-slate-700"></div>
      </div>
      <div class="pb-12">
        <h2 class="flex h-12 items-center text-xl font-bold text-slate-900 dark:text-slate-100">Share the Link</h2>
        <p class="mt-3 text-slate-600 dark:text-slate-400 leading-relaxed">
    ...
    <div class="flex gap-6">
      <div class="flex flex-col items-center">
        <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-blue-600 text-white font-bold text-lg">3</div>
        <div class="flex-1 w-px bg-slate-200 dark:bg-slate-700"></div>
      </div>
      <div class="pb-12">
        <h2 class="flex h-12 items-center text-xl font-bold text-slate-900 dark:text-slate-100">Count Together in Real Time</h2>
        <p class="mt-3 text-slate-600 dark:text-slate-400 leading-relaxed">
    ...
    <div class="flex gap-6">
      <div class="flex flex-col items-center">
        <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-blue-600 text-white font-bold text-lg">4</div>
      </div>
      <div>
        <h2 class="flex h-12 items-center text-xl font-bold text-slate-900 dark:text-slate-100">Organize with Dashboards</h2>
        <p class="mt-3 text-slate-600 dark:text-slate-400 leading-relaxed">
