  ...
  <div class="space-y-12">
    ...
    <div class="flex gap-6">
      <div class="flex flex-col items-center">
        ...
        <div class="flex-1 w-px bg-slate-200 dark:bg-slate-700 mt-3"></div>
      </div>
      <div class="pb-8">
        <h2 class="text-xl font-bold text-slate-900 dark:text-slate-100">Create a Counter</h2>
    ...
    <div class="flex gap-6">
      ...
      <div class="pb-8">
        <h2 class="text-xl font-bold text-slate-900 dark:text-slate-100">Share the Link</h2>
        <p class="mt-3 text-slate-600 dark:text-slate-400 leading-relaxed">
    ...
    <div class="flex gap-6">
      ...
      <div class="pb-8">
        <h2 class="text-xl font-bold text-slate-900 dark:text-slate-100">Count Together in Real Time</h2>
        <p class="mt-3 text-slate-600 dark:text-slate-400 leading-relaxed">
    ...
    <div class="flex gap-6">
      ...
      <div>
        <h2 class="text-xl font-bold text-slate-900 dark:text-slate-100">Organize with Dashboards</h2>
        <p class="mt-3 text-slate-600 dark:text-slate-400 leading-relaxed">
